...
ggplot(data=d2,aes(x=assignmentSize,y=value,color=variable)) + geom_point(alpha=0.5) + geom_smooth(alpha=0.7) +  scale_y_log10()
summary(lm(log(value) ~ 0 + variable + variable:log(assignmentSize),data=d2))
